...
// import { MedicalLeaveCondition } from "../model/MedicalLeaveCondition.js"
// import { MedicalLeave } from "../model/MedicalLeave.js"
...
//     const result = await MedicalLeave.find({
//         $and: [
//             { emp_id: emp_id },
...
//     const availableLeave = leaveCondtion - spendedLeaves
...
//         if (!req.body.replacement_name)
//             throw Error("Your Replacement's name is missing")
//         if (!req.body.replacement_designation)
//             throw Error("Your Replacement's designation is missing")
...
//             },
//             prefix_date: req.body.prefix_date,
//             suffix_date: req.body.suffix_date,
//             doctor_name: req.body.doctor_name,
//             date_of_prescription: req.body.date_of_prescription,
//             replacement_name: req.body.replacement_name,
//             replacement_designation: req.body.replacement_designation,
...
// //Using -- get details on user side
// export const getMedicalDetail = async (req, res) => {
//     const out = {}
//     try {
//         const emp_id = req.body.emp_id
...
//         const leaveCheck = await MedicalLeave.find(conditions)
//             .sort({ applied_on: -1 })
...
//         const itemPerPage = 5
//         const total = await MedicalLeave.find(conditions).countDocuments()
...
//         const leaveCheck = await MedicalLeave.distinct("emp_id", conditions)
...
//         const total = await MedicalLeave
//             .find(conditions.length > 0 ? { $and: conditions } : {})
//             .countDocuments()

//         const leaveCheck = await MedicalLeave
//             .find(conditions.length > 0 ? { $and: conditions } : {})
//             .sort({ applied_on: "asc" })
//             .skip(pageNumber > 1 ? ((pageNumber - 1) * itemPerPage) : 0)
//             .limit(itemPerPage)
...
//         out.message = "success"
//         out.error = false
//         out.data = await MedicalLeave.updateOne({ _id: id }, { $set: update })
...
//         //update here
//         await MedicalLeaveCondition.deleteMany({})
//         const lc = new MedicalLeaveCondition({
//             updated_by: emp_id,
//             yearly: yearly_leave,
